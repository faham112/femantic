...
def ensure_columns():
    stmts = [
        ...
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS plan_slug VARCHAR(32) DEFAULT 'lite'",
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS max_sites INTEGER DEFAULT 1",
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS max_pageviews_month INTEGER DEFAULT 50000",
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS upgrade_requested BOOLEAN DEFAULT FALSE",
