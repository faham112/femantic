...
import api, { getMe, formatDuration } from "@/lib/api";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setStats(res.data);
        setSeries(ser.data || { current: [], previous: [] });
...
export default function AnalyticsPage() {
  return <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="w-7 h-7 animate-spin" /></div>}><AnalyticsInner /></Suspense>;
}
